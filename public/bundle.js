...
let addButton = (parent, specs) => {
    ...
    button.onclick = (e) => {
        e.preventDefault();
        let container = document.getElementsByClassName("scheduler-container")[0];
