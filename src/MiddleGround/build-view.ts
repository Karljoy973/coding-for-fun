...
export let buildView = () => {
  ...
  let baseDeleteButtonClass = "ui-component button base-hour-button-class ";
  let deleteButton = document.createElement("div");
  deleteButton.setAttribute("class", baseDeleteButtonClass);
  //icon
  let d_i = document.createElement("i");
  d_i.setAttribute("class", "fa-solid fa-xmark ");
  deleteButton.appendChild(d_i);
  ...
  let fullChildren = [
    ...clockContainerChildren,
    ...cadrantChildren,
    ...lightChildren,
    ...hourElementChildren,
    ...buttonContainerChildren,
  ];
  fullChildren.forEach((child: HTMLElement) =>
    child.setAttribute("id", Id.Build())
  );
