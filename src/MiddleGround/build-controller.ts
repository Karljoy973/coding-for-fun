export let buildController = (
  ...
  setInterval(() => {
    ...
    console.log(registeredViews.secundsDigitElement.innerText);
  }, 10);
  ...
  registeredViews.settingsButton.addEventListener("click", (e) => {
    ...
    if (currentState == states[1]) {
      registeredViews.hourDigitElement.setAttribute("class", "isBlinking");
    ...
    if (currentState == states[2]) {
      ...
      registeredViews.minutesDigitElement.setAttribute("class", "isBlinking");
    } else {
      registeredViews.minutesDigitElement.setAttribute("class", "");
    }
